/* Zadanie 11: Rozbudowana konstrukcyjnie lista
 * 
...
int genFib(MyNode *node);


int main()
{  
    std::cout << "Rozpoczynamy zadanie 11: Rozbudowana lista!" << std::endl;
    ...
    {     
        ...
        std::cout << "\nZagadka: " << std::endl;
        std::cout << "Jak napisac generator dla ciagu Fibonacciego?" << std::endl;
        std::cout << "(podpowiedź: lista musi być dwukierunkowa...)" << std::endl <<std::endl;
        std::cout << "------------Ciag Fibonacciego----------------" << std::endl<<std::endl;
        std::cout << "Konstruktor wykorzystujący funkcje generujaca kolejne wyrazy ciagu Fibonacciego:" << std::endl<<std::endl;
        std::cout << "Ile wyrazow ciagu wypisac:";
        int n;
        std::cin >> n;
        MyList addFib(genFib, n);
        describeList(addFib);
    }
...
int genFib(MyNode * node)
{
  if (!node) return 0;
    ...
    return node->prev() ? node->prev()->val() + node->val() : 1; 
}

/************************* OUTPUT *************************
Rozpoczynamy zadanie 11: Rozbudowana lista!
...
KONST: funkcja generująca
List: size = 5 : [0, 2, 4, 6, 8]
KONST: funkcja generująca
List: size = 5 : [1, 2, 4, 8, 16]

Zagadka: 
Jak napisac generator dla ciagu Fibonacciego?
(podpowiedź: lista musi być dwukierunkowa...)
DESTRUKTOR (rozmiar = 5)
DESTRUKTOR (rozmiar = 5)
**********************************************************/
